...
//
// Solidity: function getAllServices() view returns((address,string,(uint256,uint256,uint256,uint256,string),uint256,address,bool,uint256)[] services)
...
//
// Solidity: function getService(address provider) view returns((address,string,(uint256,uint256,uint256,uint256,string),uint256,address,bool,uint256) service)
...
// AddOrUpdateService is a paid mutator transaction binding the contract method 0x5573849a.
//
// Solidity: function addOrUpdateService(string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour) returns()
func (_FineTuningServing *FineTuningServingTransactor) AddOrUpdateService(opts *bind.TransactOpts, url string, quota Quota, pricePerToken *big.Int, providerSigner common.Address, occupied bool, pricePerHour *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.contract.Transact(opts, "addOrUpdateService", url, quota, pricePerToken, providerSigner, occupied, pricePerHour)
}

// AddOrUpdateService is a paid mutator transaction binding the contract method 0x5573849a.
//
// Solidity: function addOrUpdateService(string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour) returns()
func (_FineTuningServing *FineTuningServingSession) AddOrUpdateService(url string, quota Quota, pricePerToken *big.Int, providerSigner common.Address, occupied bool, pricePerHour *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.Contract.AddOrUpdateService(&_FineTuningServing.TransactOpts, url, quota, pricePerToken, providerSigner, occupied, pricePerHour)
}

// AddOrUpdateService is a paid mutator transaction binding the contract method 0x5573849a.
//
// Solidity: function addOrUpdateService(string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour) returns()
func (_FineTuningServing *FineTuningServingTransactorSession) AddOrUpdateService(url string, quota Quota, pricePerToken *big.Int, providerSigner common.Address, occupied bool, pricePerHour *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.Contract.AddOrUpdateService(&_FineTuningServing.TransactOpts, url, quota, pricePerToken, providerSigner, occupied, pricePerHour)
}
...
// SettleFailedTaskFees is a paid mutator transaction binding the contract method 0xd6e1496b.
//
// Solidity: function settleFailedTaskFees(address user, uint256 taskFee) returns()
func (_FineTuningServing *FineTuningServingTransactor) SettleFailedTaskFees(opts *bind.TransactOpts, user common.Address, taskFee *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.contract.Transact(opts, "settleFailedTaskFees", user, taskFee)
}

// SettleFailedTaskFees is a paid mutator transaction binding the contract method 0xd6e1496b.
//
// Solidity: function settleFailedTaskFees(address user, uint256 taskFee) returns()
func (_FineTuningServing *FineTuningServingSession) SettleFailedTaskFees(user common.Address, taskFee *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.Contract.SettleFailedTaskFees(&_FineTuningServing.TransactOpts, user, taskFee)
}

// SettleFailedTaskFees is a paid mutator transaction binding the contract method 0xd6e1496b.
//
// Solidity: function settleFailedTaskFees(address user, uint256 taskFee) returns()
func (_FineTuningServing *FineTuningServingTransactorSession) SettleFailedTaskFees(user common.Address, taskFee *big.Int) (*types.Transaction, error) {
	return _FineTuningServing.Contract.SettleFailedTaskFees(&_FineTuningServing.TransactOpts, user, taskFee)
}
...
// FilterServiceUpdated is a free log retrieval operation binding the contract event 0xbbcd4117d02c6890eefa9df183fe6e221989a7140cf8bbe92cc4c22d4dc6b1bd.
//
// Solidity: event ServiceUpdated(address indexed user, string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour)
...
// WatchServiceUpdated is a free log subscription operation binding the contract event 0xbbcd4117d02c6890eefa9df183fe6e221989a7140cf8bbe92cc4c22d4dc6b1bd.
//
// Solidity: event ServiceUpdated(address indexed user, string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour)
...
// ParseServiceUpdated is a log parse operation binding the contract event 0xbbcd4117d02c6890eefa9df183fe6e221989a7140cf8bbe92cc4c22d4dc6b1bd.
//
// Solidity: event ServiceUpdated(address indexed user, string url, (uint256,uint256,uint256,uint256,string) quota, uint256 pricePerToken, address providerSigner, bool occupied, uint256 pricePerHour)
